...
folder are mapped to the application's root namespace, 'SevenAdmin'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SevenAdmin"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SevenAdmin' in the same way
as `"SevenAdmin/sass/src"`.
