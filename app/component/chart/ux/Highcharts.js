 ...
 *
 *       var chart = new Ext.create('SevenAdmin.component.chart.ux.Highcharts', {
 *                       ....
 *                   });
 ...
 * to the desired {@link SevenAdmin.component.chart.ux.Highcharts.Serie} class and {@link SevenAdmin.component.chart.ux.Highcharts.Serie#method-getData}
 ...
 * {@link SevenAdmin.component.chart.ux.Highcharts.Serie} class and {@link SevenAdmin.component.chart.ux.Highcharts.Serie#cfg-dataIndex} configuration for
 ...
 * created without any datasets. However, the chart initial animation ({@link SevenAdmin.component.chart.ux.Highcharts#cfg-initAnimAfterLoad})
 ...
 *          ...
 *      }
 * Once the chart is displayed, the dynamic series can be displayed via {@link SevenAdmin.component.chart.ux.Highcharts#method-addSeries} method
 ...
 */
Ext.define("SevenAdmin.component.chart.ux.Highcharts", {
    extend: 'Ext.Component',
    alias: ['widget.highchart', 'widget.highcharts'],
    requires: [
        'SevenAdmin.component.chart.ux.serie.AreaRangeSerie',
        'SevenAdmin.component.chart.ux.serie.AreaSerie',
        'SevenAdmin.component.chart.ux.serie.AreaSplineRangeSerie',
        'SevenAdmin.component.chart.ux.serie.AreaSplineSerie',
        'SevenAdmin.component.chart.ux.serie.BarSerie',
        'SevenAdmin.component.chart.ux.serie.BoxPlotSerie',
        'SevenAdmin.component.chart.ux.serie.BubbleSerie',
        'SevenAdmin.component.chart.ux.serie.ColumnRangeSerie',
        'SevenAdmin.component.chart.ux.serie.ColumnSerie',
        'SevenAdmin.component.chart.ux.serie.ErrorBarSerie',
        'SevenAdmin.component.chart.ux.serie.FunnelSerie',
        'SevenAdmin.component.chart.ux.serie.GaugeSerie',
        'SevenAdmin.component.chart.ux.serie.HeatmapSerie',
        'SevenAdmin.component.chart.ux.serie.LineSerie',
        'SevenAdmin.component.chart.ux.serie.MapBubbleSerie',
        'SevenAdmin.component.chart.ux.serie.MapLineSerie',
        'SevenAdmin.component.chart.ux.serie.MapPointSerie',
        'SevenAdmin.component.chart.ux.serie.MapSerie',
        'SevenAdmin.component.chart.ux.serie.PieSerie',
        'SevenAdmin.component.chart.ux.serie.PyramidSerie',
        'SevenAdmin.component.chart.ux.serie.RangeSerie',
        'SevenAdmin.component.chart.ux.serie.ScatterSerie',
        'SevenAdmin.component.chart.ux.serie.SolidGaugeSerie',
        'SevenAdmin.component.chart.ux.serie.SplineSerie',
        'SevenAdmin.component.chart.ux.serie.WaterfallSerie'
    ],
    statics: {
        /***
         * @static
    ...
    basicSerieCls: "SevenAdmin.component.chart.ux.serie.Serie",
     ...
     * A delay to call {@link SevenAdmin.component.chart.ux.Highcharts#method-draw} method
     */
    updateDelay: 0,
    ...
    initComponent: function () {
        ...
        if (this.chartConfig) {
            if (!this.chartConfig.credits) {
                this.chartConfig.credits = {
                    enabled: false
                };
            }
    ...
    buildInitData: function () {
        ...
        if (!this.store || this.store.isLoading() || !_this.chartConfig || _this.initAnim === false ||
    ...
    /**
     * A function to delay the call to {@link SevenAdmin.component.chart.ux.Highcharts#method-draw} method
