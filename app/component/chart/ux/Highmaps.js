 ...
 * {@link SevenAdmin.component.chart.ux.serie.MapSerie} for details.
 * Finally, change the constructor
 * to ExtJs style as follows:
 *
 *     var map = Ext.Create('SevenAdmin.component.chart.ux.Highmaps', {
 *         chartConfig {
 *              ....
 *         },
 *         series : [{
 ...
 * 
 */
Ext.define("SevenAdmin.component.chart.ux.Highmaps", {
    extend: 'SevenAdmin.component.chart.ux.Highcharts',
    alias: ['widget.highmaps'],
    mixins: {
        observable: 'Ext.util.Observable'
    },
    basicSerieCls: "SevenAdmin.component.chart.ux.serie.MapSerie",
    ...
    addSeries: function (series, append) {
        ...
        var HC = SevenAdmin.component.chart.ux.Highcharts;
