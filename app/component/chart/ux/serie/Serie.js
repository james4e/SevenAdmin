 ...
 * series classes directly, they are created internally from SevenAdmin.component.chart.ux.Highcharts depending on the
 ...
 *     }
 *
 * Then use {@link SevenAdmin.component.chart.ux.serie.Serie#cfg-dataIndex} to map the series data array
 *
 *     series: [{
 *         name: 'Series A',
 *         dataIndex: 'series1'
 ...
 */
Ext.define('SevenAdmin.component.chart.ux.serie.Serie', {
    requires: [
        'Ext.util.Observable'
    ],
    mixins: {
    ...
    /**
     * @readonly
     * The {@link SevenAdmin.component.chart.ux.Highcharts} chart object owns this serie.
     * @type Object/SevenAdmin.component.chart.ux.Highcharts
     *
    ...
    constructor: function (config) {
        ...
        var sencha = SevenAdmin.component.chart.ux.Highcharts.sencha;
        ...
        if (sencha.product == 't') {
            ...
            this.addEvents(
                 ...
                 * @param {SevenAdmin.component.chart.ux.serie.Serie}  serie the serie where is fired
    ...
    buildInitData: function (items, data) {
        ...
        if (SevenAdmin.component.chart.ux.Highcharts.sencha.product == 't') {
